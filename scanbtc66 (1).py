...
def process_range(start, end):
    for _ in range(start, end):
        ran = random.randint(30003488147419103260, 80786976294838206520)
        ...
        logging.info('---scanbtc66.py--- Random Scan for Bitcoin Addresses and Check Balance ---Weatose ---scanbtc66.py--- %s', seconds_to_str())
        ...
        if float(bal) or float(bal1) > 0:
            ...
            with open("Weatose00Donations00bc1qsxs2eudlfgstfrnssn5l2athagfjp0zwrqvszs.txt", "a") as f:
...
count = 0
total = 0
num_processes = 5  # Number of processes to run concurrently
