...
#This function sets the lists and calls the core function with all possible combinations
...
#If an user doesn't know the chunk size,we have to try all possible chunk sizes starting from 1
    
    chunk_size = [x for x in range(1,101)] 

# If you want, you can increase the range of chunk_size. But beware about the time complexity. Only setting 100 items here could take more than 100 years!
